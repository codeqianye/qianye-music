package cn.qiany.basic.framework.jackson.config;

import cn.qiany.basic.framework.common.util.json.JsonUtils;
import cn.qiany.basic.framework.common.util.json.databind.NumberSerializer;
import cn.qiany.basic.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.qiany.basic.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class QybasicJacksonAutoConfiguration {
