package cn.qiany.basic.framework.web.config;
...
import cn.qiany.basic.framework.web.core.filter.CacheRequestBodyFilter;
import cn.qiany.basic.framework.web.core.filter.DemoFilter;
import cn.qiany.basic.framework.web.core.handler.GlobalExceptionHandler;
import cn.qiany.basic.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class QybasicWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "qybasic.demo", havingValue = "true")
