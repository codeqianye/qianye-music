package cn.qiany.basic.framework.tracer.config;

import cn.qiany.basic.framework.common.enums.WebFilterOrderEnum;
import cn.qiany.basic.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "qybasic.tracer", value = "enable", matchIfMissing = true)
public class QybasicTracerAutoConfiguration {
