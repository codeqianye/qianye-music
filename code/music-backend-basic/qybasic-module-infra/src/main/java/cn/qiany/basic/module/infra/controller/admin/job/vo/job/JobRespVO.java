package cn.qiany.basic.module.infra.controller.admin.job.vo.job;
...
import cn.qiany.basic.module.infra.enums.DictTypeConstants;
...
public class JobRespVO {
    ...
    @Schema(description = "处理器的参数", example = "qybasic")
