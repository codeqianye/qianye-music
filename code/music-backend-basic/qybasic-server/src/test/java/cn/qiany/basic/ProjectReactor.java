...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.qiany.boot";
    private static final String ARTIFACT_ID = "qybasic";
    private static final String PACKAGE_NAME = "cn.qiany.basic";
    private static final String TITLE = "千夜音乐";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.qiany.boot";
        String artifactIdNew = "qybasic";
        String packageNameNew = "cn.qiany.basic";
        String titleNew = "千夜音乐";
        //String projectBaseDirNew = projectBaseDir + "-new"; // 一键改名后，“新”项目所在的目录
        String projectBaseDirNew = projectBaseDir.substring(0, projectBaseDir.lastIndexOf("\\") + 1) + "music-backend-basic";
