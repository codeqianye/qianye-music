package cn.qiany.basic.module.system.service.social;
...
import cn.qiany.basic.framework.common.util.cache.CacheUtils;
import cn.qiany.basic.framework.common.util.http.HttpUtils;
import cn.qiany.basic.framework.common.util.object.BeanUtils;
import cn.qiany.basic.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.qiany.basic.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.qiany.basic.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import cn.qiany.basic.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.qiany.basic.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.qiany.basic.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.qiany.basic.module.system.dal.dataobject.social.SocialClientDO;
import cn.qiany.basic.module.system.dal.mysql.social.SocialClientMapper;
import cn.qiany.basic.module.system.dal.redis.RedisKeyConstants;
import cn.qiany.basic.module.system.enums.social.SocialTypeEnum;
import cn.qiany.basic.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.qiany.basic.framework.common.util.collection.MapUtils.findAndThen;
import static cn.qiany.basic.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.qiany.basic.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static cn.qiany.basic.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${qybasic.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${qybasic.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/qybasic-cloud/pulls/230
