package cn.qiany.basic.module.system.controller.admin.socail.vo.client;
...
import cn.qiany.basic.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "qybasic商城")
