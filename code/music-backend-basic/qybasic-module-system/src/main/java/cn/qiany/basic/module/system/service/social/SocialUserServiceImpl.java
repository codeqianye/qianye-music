...
import cn.qiany.basic.module.system.controller.admin.socail.vo.user.SocialUserPageReqVO;
import cn.qiany.basic.module.system.dal.dataobject.social.SocialUserBindDO;
import cn.qiany.basic.module.system.dal.dataobject.social.SocialUserDO;
import cn.qiany.basic.module.system.dal.mysql.social.SocialUserBindMapper;
import cn.qiany.basic.module.system.dal.mysql.social.SocialUserMapper;
...
import static cn.qiany.basic.module.system.enums.ErrorCodeConstants.SOCIAL_USER_NOT_FOUND;
...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    public SocialUserDO authSocialUser(Integer socialType, Integer userType, String code, String state) {
        ...
        if (socialUser.getId() == null) {
            ...
            socialUser.clean(); // 避免 updateTime 不更新：https://gitee.com/qybasiccode/qybasic-boot-mini/issues/ID7FUL
